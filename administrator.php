...
<body>
    <?php 
        ...
        if(isset($_SESSION['username']) && $_SESSION['level'] == 1) {
            ...
            $userMessage = '<p>Bok ' . htmlspecialchars($_SESSION['username']) . '! Uspješno ste prijavljeni kao administrator.</p>';
        } else if(isset($_SESSION['username'])) {
            // Korisnik je prijavljen, ali nije administrator
            $userMessage = '<p>Bok ' . htmlspecialchars($_SESSION['username']) . '! Uspješno ste prijavljeni.</p>';
            ...
            if (password_verify($prijavaLozinkaKorisnika, $lozinkaKorisnika) && mysqli_stmt_num_rows($stmt) > 0) { 
                ...
                $userMessage = "<p>Pogrešno korisničko ime ili lozinka!</p>"; 
            } 
        }
    ?>
            ...
            <div class="container d-flex align-items-end">
                ...
                <ul class="d-inline-block">
                    ...
                    <?php if(isset($_SESSION['username'])): ?>
                        <li><a href="logout.php">Odjava (<?php echo htmlspecialchars($_SESSION['username']); ?>)</a></li>
                    <?php else: ?>
    ...
    <?php 
        ...
        if(isset($_POST['update'])){ 
            ...
            if (!empty($_FILES['pphoto']['name'])) {
                ...
                <!-- login.php (assuming you want to create a separate login page) -->
                <!DOCTYPE html>
                <html lang="hr">
                <head>
                    <meta charset="UTF-8">
